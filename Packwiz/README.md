...
The `.sh` scripts are for the users that want to disable some mods from FO. [See the tutorial for more info.](https://fabulously-optimized.gitbook.io/modpack/multimc-auto-update#can-i-ignore-some-of-the-mods)
