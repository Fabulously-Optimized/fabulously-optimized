...
* Modrinth - [website is planned](https://github.com/Madis0/fabulously-optimized/issues/63), but initial mrpacks are available on latest [GitHub releases](https://github.com/Fabulously-Optimized/fabulously-optimized/releases)
